...
public class JDBC {
  ...
  private static final String DB_URL = "jdbc:mysql://localhost:8080/jdbc";
  ...
  public static String getAllData()
  {
    ...
    try {
      ...
      String query = "SELECT invoiceNumber, customerName, NoHP, alamat,itemName, price, quantity FROM transaksi";
      ...
      while( resultData.next() ){
        data += "invoiceNumber : " + resultData.getInt("invoiceNumber") + "| customerName : " + resultData.getString("customerName")+ "| NoHP : " + resultData.getString("NoHP") + "| alamat : " + resultData.getString("alamat") + "| itemName : " + resultData.getString("itemName") + "| price : " + resultData.getDouble("price") + "| quantity : " + resultData.getInt("quantity") + "\n";
      }
